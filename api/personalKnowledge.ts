...
export const personalKnowledge: KnowledgeChunk[] = [
    // ========== 性格特质 ==========
    {
        ...
        keywords: ['性格', '人格', '特质', '特点', '自我评价', '是什么样的人'],
        content: `核心性格特质：
我是一个高度自省、以事实和逻辑为核心行动依据的人。
- 不热衷情绪化表达，也不依赖表层认可
- 更看重事情是否被正确理解、是否真的向前推进
- 在复杂环境中仍坚持独立思考的产品型个体`,
        visibility: '公开',
    },
    {
        id: 'self-thinking',
        category: 'personality',
        keywords: ['思维', '逻辑', '分析', '独立', '思考'],
        content: `思维方式：
- 习惯先厘清问题本质，再推进解决方案
- 做事细致、结构化，擅长将复杂、模糊的信息拆解为清晰的框架
- 不盲从权威，保持独立判断
- 对评价保持谨慎态度——不抗拒被质疑，但拒绝模糊、情绪化或缺乏依据的判断`,
        visibility: '公开',
    },
    {
        id: 'self-values',
        category: 'personality',
        keywords: ['价值观', '原则', '理念', '长期'],
        content: `价值观与原则：
- 认同长期主义与微小但持续的积累
- 相信真实表达本身就是一种能力，也是一种风险管理
- 不讨好、不对抗，只对事实负责
- 更希望对方理解我的意图和决策逻辑，而非简单给我贴标签`,
        visibility: '公开',
    },
    ...
    // ========== 工作风格 ==========
    {
        id: 'work-style-core',
        category: 'work_style',
        keywords: ['工作风格', '做事', '工作方式', '风格'],
        content: `工作风格：
- 做事细致、结构化，擅长将复杂、模糊的信息拆解为清晰的框架
- 通过文档、流程或产品形态落地
- 主动借助 AI 工具提升效率，但更在意背后的方法论是否可复用、是否长期有效`,
        visibility: '公开',
    },
    {
        id: 'work-boundaries',
        category: 'work_style',
        keywords: ['边界', '责任', '组织', '协作', '团队'],
        content: `组织协作方式：
- 不追求"表现积极"，而是倾向于明确边界
- 该承担的责任会交付清楚，不必要的消耗会主动规避
- 尊重规则，但不会盲从权威
- 可以配合协作，但不以牺牲自我判断为代价`,
        visibility: '公开',
    },
    {
        ...
        category: 'work_style',
        keywords: ['沟通', '反馈', '交流', '表达'],
        content: `沟通与反馈风格：
- 不热衷情绪化表达，更看重事情是否被正确理解
- 更希望对方理解我的意图和决策逻辑
- 直接、具体、可执行，不绕弯子
- 真实表达本身就是一种能力`,
        visibility: '公开',
    },
    {
        id: 'work-methodology',
        category: 'work_style',
        keywords: ['方法论', '工作方法', '习惯', '效率', 'AI'],
        content: `工作方法论：
- 主动借助 AI 工具提升效率（LLM 辅助需求分析、文档撰写、竞品调研）
- 更在意背后的方法论是否可复用、是否长期有效
- 每个项目结束后输出方法论文档，便于复用`,
        visibility: '公开',
    },
...
- 业务价值：从"事后维修"转向"事前预防"，降低故障停机损失`,
    ...
    },
    {
        ...
        category: 'project',
        keywords: ['招采', '招标', '招投标', '投标', '数据', '自动化', 'etl', '清洗'],
